...
public class boardContent extends AppCompatActivity {
    private TextView c_writer,c_board_title,c_viewcount,c_board_content;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c_viewcount = findViewById(R.id.c_viewcount);
        ...
        c_viewcount.setText(vo.getViewcount());
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i< jsonArray.length(); i++) {
                        ...
                        Log.v("d",cmt_seq);
                        adapter.addItem(cmt_seq, id, cmt_content, cmt_date);
