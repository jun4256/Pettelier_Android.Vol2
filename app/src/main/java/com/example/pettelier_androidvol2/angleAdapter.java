...
public class angleAdapter extends BaseAdapter {
    ...
    public void addItem(String cg_serial, String cg_time, String cg_angle) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.angle_custom_page, viewGroup, false);
        }


        TextView tv_cg_serial2 = view.findViewById(R.id.tv_cg_serial2);
        TextView tv_cg_time = view.findViewById(R.id.tv_cg_time);
        Button btn_angle_state = view.findViewById(R.id.btn_angle_state);

        CageVO cvo = items.get(i);

        tv_cg_serial2.setText(cvo.getCg_serial());
        tv_cg_time.setText(cvo.getCg_time());
        btn_angle_state.setText(cvo.getCg_angle());

        btn_angle_state.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sendRequest();
                if(cvo.getCg_angle().equals("배급하기")){
                    cvo.setCg_angle("배급하기");
                    btn_angle_state.setText("배급완료");
                }//else{
                // cvo.setCg_angle("1");
                // btn_angle_state.setText("1");
                // }
            }
            ...
            private void sendRequest() {
                ...
                // 서버에 요청할 주소
                String url = "http://210.223.239.212:8081/web/feedControl.do";
                // 고은 : 172.30.1.28:8089
                ...
                stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.length() > 0) {
                            ...
                            try {
                                ...
                                // MemberVO 만들어서 넘기기
                                loginCheck.cage_info = new CageVO(cg_serial,cg_time,cg_angle);
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        String angle = btn_angle_state.getText().toString();
                        if(angle.equals("배급완료")){
                            angle="ON";
                        } else {
                            angle = "OFF";
                        }
